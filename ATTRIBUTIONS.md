...
| `skills/tiktok-growth-plan` | `tiktok-growth-plan`, rewritten with bundled account-audit and opportunity-research methods that produce a gap matrix, retain/pause/add decisions, three growth paths, and a 30-day test rhythm without requiring sibling Skill directories |
...
This repository does not include material from `tiktok-lead-generation-operator` or `tiktok-ads-operator`.
